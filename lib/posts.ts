...
export const POSTS: Post[] = [
  ...
  },
  {
    ...
    readMins: 5,
    body: [
      { type: "p", text: "A 50 amp circuit — common for ranges, EV chargers and sub-panels — needs 6 AWG copper or 4 AWG aluminum on standard 75°C terminals. Here's why, and when you should go bigger." },
      { type: "h2", text: "Start with the ampacity table" },
      { type: "p", text: "NEC Table 310.16 lists 6 AWG copper at 65 A in the 75°C column, comfortably above 50 A. Aluminum 6 AWG is only 50 A, so most installers use 4 AWG aluminum (65 A) to leave margin." },
      { type: "h2", text: "Mind the terminal rating" },
      { type: "p", text: "You can only use the 90°C column for derating math — the final conductor still has to satisfy the temperature rating of the weakest terminal, usually 75°C. That's why 6 AWG copper, not 8 AWG, is the safe call for a true 50 A load." },
